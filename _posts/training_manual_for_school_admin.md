...
Change Grade is to change the child&#39;s grade in same academic year. Promote grade option is to promote the child to higher grade for next academic year.
...
Teacher will able to see only assigned classes while admin will able to see all the classes. Select particular class name and select the date to take the attendance. Click on the &#39;Edit&#39; button. There are 4 options (Absent, Present, Late Arrival, Leave) available to mark the status of attendance. Select attendance status and click on the &#39;Save&#39;.
